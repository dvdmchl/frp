...
export function HeaderTitle({children}: Readonly<{ children: React.ReactNode }>) {
    return (
        <h1 className="text-lg font-bold text-left text-textHeaderTitle">
            {children}
        </h1>
    )
}
...
export function H1Title({children}: Readonly<{ children: React.ReactNode }>) {
    return (
        <h1 className="text-3xl font-extrabold text-center text-textPrimary mb-4">
            {children}
        </h1>
    );
}
...
export function H2Title({children}: Readonly<{ children: React.ReactNode }>) {
    return (
        <h2 className="text-3xl font-extrabold text-center text-textPrimary mb-4">
            {children}
        </h2>
    );
}
...
export function TextError({message}: Readonly<{ message: string }>) {
    return (
        <div className="text-textError text-sm text-center my-2">
            {message}
        </div>
    );
}
