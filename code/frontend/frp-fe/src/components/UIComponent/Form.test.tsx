...
describe('Form Component', () => {
  ...
  it('accepts additional className', () => {
    render(<Form className="custom-class" data-testid="test-form">Content</Form>);
    const form = screen.getByTestId('test-form');
  ...
  it('passes other props to the form element', () => {
    const handleSubmit = () => {};
    render(<Form onSubmit={handleSubmit} data-testid="test-form">Content</Form>);
    ...
    render(<Form action="/submit" data-testid="test-form-action">Content</Form>);
